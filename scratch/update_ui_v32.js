...
let code = fs.readFileSync('scripts/xELU-v31.mjs', 'utf8');
...
// Combining the Name & Description + Strategic Roadmap
...
<div style="width: 100%; padding: 20px; display: flex; flex-direction: column; background-color: transparent; font-family: var(--framer-font-family, Satoshi, Inter, sans-serif); box-sizing: border-box; border-top: 1px solid rgba(255,255,255,0.05); margin-top: 10px;">
...
fs.writeFileSync('scripts/xELU-v32.mjs', code, 'utf8');
...
function updateReferences(dir) {
    ...
    list.forEach(file => {
        ...
        if (fs.statSync(fullPath).isDirectory()) {
            ...
            if (content.includes('xELU-v31.mjs')) {
                content = content.replace(/xELU-v31\.mjs/g, 'xELU-v32.mjs');
...
if (fs.existsSync('scripts/xELU-v31.mjs')) {
    fs.unlinkSync('scripts/xELU-v31.mjs');
}
updateReferences('.');

console.log("Updated Step 1 (Strategy card) to Strategic Roadmap v32! (Fixed size)");
