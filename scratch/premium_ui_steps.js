...
function updateReferences(dir) {
    ...
    list.forEach(file => {
        ...
        if (fs.statSync(fullPath).isDirectory()) {
            ...
            if (content.includes('xELU-v25.mjs')) {
                content = content.replace(/xELU-v25\.mjs/g, 'xELU-v26.mjs');
                fs.writeFileSync(fullPath, content, 'utf8');
            }
        }
    });
}
if (fs.existsSync('scripts/xELU-v25.mjs')) {
    fs.unlinkSync('scripts/xELU-v25.mjs');
}
updateReferences('.');

console.log("Updated Step 3 and Step 4 UIs to PREMIUM versions!");
