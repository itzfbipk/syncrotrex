...
let code = fs.readFileSync('scripts/xELU-v24.mjs', 'utf8');
...
fs.writeFileSync('scripts/xELU-v25.mjs', code, 'utf8');
...
function updateReferences(dir) {
    ...
    list.forEach(file => {
        ...
        if (fs.statSync(fullPath).isDirectory()) {
            ...
            if (content.includes('xELU-v24.mjs')) {
                content = content.replace(/xELU-v24\.mjs/g, 'xELU-v25.mjs');
                fs.writeFileSync(fullPath, content, 'utf8');
            }
        }
    });
}
if (fs.existsSync('scripts/xELU-v24.mjs')) {
    fs.unlinkSync('scripts/xELU-v24.mjs');
}
updateReferences('.');

console.log("Updated Step 4 UI!");
