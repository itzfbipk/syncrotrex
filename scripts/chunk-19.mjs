...
var r,
  ...
  s = e(() => {
    (n(),
      t.loadFonts([
        `GF;Figtree-variable-regular`,
        `GF;Figtree-variable-regularVF=IndnaHQiIDU1MA==`,
        `GF;Figtree-variable-regularVF=IndnaHQiIDU1MA==`,
        `GF;Figtree-variable-regularVF=IndnaHQiIDU1MA==`,
      ]),
      (r = [
          ...
          fonts: [
            {
              ...
              source: `google`,
              style: `normal`,
              url: `https://fonts.gstatic.com/s/figtree/v7/_Xms-HUzqDCFdgfMq4a3DIZs3ik.woff2`,
              variationAxes: r,
              weight: `400`,
            },
          ],
...
export { s as i, a as n, i as r, o as t };
//# sourceMappingURL=chunk-19.mjs.map
